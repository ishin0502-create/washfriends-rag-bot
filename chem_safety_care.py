...
def _never_mix() -> dict[str, str]:
    return {
        ...
        "why_ko": (
            ...
            "염소+식초(산)도 유독 가스·자극 — 절대 혼합 금지. "
            "‘집에서 섞어 강하게’ 요구는 거절."
        ),
        "fresh_path_ko": (
            "(1)라벨·코드 확인. (2)B2와 A5·식초(산) 절대 혼합·연속 미헹굼 사용 금지. "
            "(3)한 약품 처리→충분히 헹굼→다음. (4)환기. "
            "(5)대사: 「락스와 식초·암모니아는 섞으면 가스 — 각각 쓰고 헹굽니다」."
        ),
        ...
        "refuse_when_ko": "락스+암모니아·락스+식초 혼합 요구 → 즉시 거절.",
        "must_include_ko": "B2+A5·B2+식초 금지, 헹굼 후 다음 약, 환기, 혼합 거절",
