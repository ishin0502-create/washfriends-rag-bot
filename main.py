...
async def health():
    ...
    return JSONResponse(
        content={
            ...
            "build": "2026-08-10-vi-education-v12",
            "checks": checks,
        },
        status_code=200,
    )
...
UNWIND [
  {id:'S_VOMIT',
   ...
   force_metaphor_vi:'Cap2: cạo nhẹ + thấm — không chà đẩy acid vào sợi',
   ...
   success_rate_vi:'Xử lý sớm + đúng PPE: 60–80%. Đã sấy / lụa: thấp — báo trước.',
  ...
  {id:'S_URINE',
   why_vi:'[Tại sao] Nuoc tieu tuoi = urea+muoi (de). KHO = vi khuan → ammonia + uric acid (khong tan nuoc thuong) → mui khai + vang. BAT BUOC gang. CAM A5 ammonia (cong mui). CAM B2+ammonia (khi doc). THU TU: tham/xa lanh → E1 (pha uric) → A3 trung hoa → B1 neu vang trang.',
  ...
  {id:'S_FECES',
   why_vi:'[Tại sao] Phan = protein + vi khuan (nguy co cao) + sac to mat (bile) kho tay. PPE NANG: gang day + khau trang + khu rieng + sat khuan ban. CAM tron voi do sach. CAM nong luc dau. THU TU: cao ran → xa lanh → E1 cao → B1 mau mat → giat nhiet cao an toan + UV.',
  ...
  {id:'S_BABY_FORMULA',
   why_vi:'[Tại sao] Sua bot = casein/whey + mo thuc vat + SAT (iron) + lactose. Kho hon sua tuoi. CAM B2 (chlorine + sat = vet CAM VINH VIEN). CAM nong luc dau (khoa sat+protein). THU TU: cao → xa lanh → D2 (mo) → E1 (protein) → A3 neu vang/cam (sat) → giat am nhe. Phoi nang tot cho do be.',
