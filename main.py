...
async def health():
    ...
    return JSONResponse(
        content={
            ...
            "build": "2026-08-07-tool-howto-bind",
            "checks": checks,
        },
        status_code=200,
    )
...
UNWIND [
  ...
  {id:'T_SPRAY',name_vi:'Binh xit (moi hoa chat 1 binh + ghi ten/ty le)',name_ko:'분무기(약마다 따로·겉에 이름·비율 쓰기)',
   use_for_vi:'Pha dung dich cua vet (vd giam 1:4) vao binh RIENG — khong tron thuoc khac. Viet len binh ten+ty le. Xit 1-2 phat, khong ngap.',
  ...
  {id:'T_TIMER',name_vi:'Dong ho hen gio',name_ko:'타이머',
   use_for_vi:'Dat hen gio DUNG so phut cua quy trinh (vd 15-45). Het gio → xa ngay. Khong de qua dem.',
  ...
  {id:'T_SOAK_BIN',name_vi:'Chau ngam / thung ngam',name_ko:'담금통·침지 용기',
   use_for_vi:'Pha dung dich, ngam DUNG so phut (vd 15-45). Dan nhan. CAM ngam suit/caravat/lua mong neu SOP cam.',
