...
async def health():
    ...
    return JSONResponse(
        content={
            ...
            "build": "2026-08-10-vi-shop-speak-v14",
            "checks": checks,
        },
        status_code=200,
    )
...
UNWIND [
  ...
  {id:'S_NAIL_POLISH',
   why_vi:'[Tại sao] Son mong = nitrocellulose + pigment + dung moi. A2 (acetone) TU MAT TRAI + giay tham — KHONG cha lan. CAM acetate/rayon (tan vai). Test goc. Ty le thap neu da kho lau.',
   fresh_path_vi:'(1) Test goc. (2) Giay tham duoi. (3) A2 cham mat TRAI Cap1, doi giay. (4) Lap den het mau. (5) D2 xa. (6) Giat. Anh sang TRUOC say.',
   dried_path_vi:'A2 lap nhieu. Bao khong 100%. Acetate → dung/chuyen.',
   force_metaphor_vi:'Cap1 blot mat trai — cha = lan pigment',
   force_metaphor_ko:'Cap1: 안쪽에서 찍기 — 문지르면 색소 확산',
   sense_check_vi:'Mat: mau giam tung blot. Tay: het dan son.',
   sense_check_ko:'눈: 블롯마다 색소 감소. 손: 끈적임 없음.',
   success_rate_vi:'Tuoi: trung binh. Kho lau: thap — bao truoc.',
   success_rate_ko:'신선: 중간. 오래된: 낮음 — 사전 고지.',
   refuse_when_vi:'Acetate/rayon + A2. In hoa mong. Khong cam ket 100%.',
