...
async def health():
    ...
    return JSONResponse(
        content={
            ...
            "build": "2026-08-07-protocol-v3b-skip-legacy-chem",
            "checks": checks,
        },
        status_code=200,
    )
...
UNWIND [
  {id:'T_BRUSH_SOFT',name_vi:'Bàn chải spotting mềm',name_ko:'연질 스포팅 솔',
   use_for_vi:'Dùng trên cotton/poly: chấm 45°, 1 chiều NGOÀI→TRONG Cap2 — không chà qua lại. Không dùng trên lụa/len (đổi sang bàn chải siêu mềm).',
  ...
  {id:'T_BRUSH_HARD',name_vi:'Bàn chải spotting cứng',name_ko:'경질 스포팅 솔',
   use_for_vi:'Chỉ denim/canvas/đế giày/bùn: Cap3 ngắn. CẤM mesh, lụa, len, vải mỏng.',
  ...
  {id:'T_BRUSH_ULTRA',name_vi:'Bàn chải siêu mềm / miếng foam',name_ko:'초연질 솔·스펀지',
   use_for_vi:'Lụa/len/vải mỏng/đồ tinh tế: Cap1, chỉ đập/thấm — KHÔNG chà. Có thể dùng miếng foam thay bàn chải.',
  ...
  {id:'T_CLOTH',name_vi:'Khăn trắng sạch / giấy thấm',name_ko:'흰 천·흡수지',
   use_for_vi:'(1) Khăn trắng: CHẤM/THẤM lên vết NGOÀI→TRONG, đổi khăn khi nhuốm màu. (2) Giấy/khăn lót DƯỚI vải để không loang mặt sau. Dùng khăn trắng để THẤY màu chuyển.',
