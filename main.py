...
async def health():
    ...
    return JSONResponse(
        content={
            ...
            "build": "2026-08-08-specialty-item-care-v4b",
            "checks": checks,
        },
        status_code=200,
    )
...
UNWIND [
  ...
  {id:'T_MESH_BAG',name_vi:'Tui luoi giat',name_ko:'세탁망',
   use_for_vi:'(runtime) Rem/chan/do mong — theo item.',
...
UNWIND [
  {id:'S_BBQ_SAUCE',
   why_vi:'GIAO DUC: Sot BBQ = duong/tomate mau + dau + protein (neu thit). 3 LOP: E1 protein → D2 dau → A3 tannin/mau → B1 trang neu can. CAM nong/say khi con vet — khoa mau+duong.',
  ...
  {id:'S_MUSTARD',
   why_vi:'GIAO DUC: Mu-ta-det = curcumin mau vang (UV nhay) + bot. THU TU: cao → paste baking soda → B1/oxy → PHOI NANG (UV tay mau). CAM say khi con vang.',
  ...
  {id:'S_NAIL_POLISH',
   why_vi:'GIAO DUC: Son mong = nitrocellulose + pigment + dung moi. A2 (acetone) TU MAT TRAI + giay tham — KHONG cha lan. CAM acetate/rayon (tan vai). Test goc. Ty le thap neu da kho lau.',
  ...
  {id:'S_GLUE',
   why_vi:'GIAO DUC: Xac dinh loai keo TRUOC. 502/cyano: A2. Acrylic: N3/dau. Bang dinh: A1. Sai dung moi = te hon. Cao bot truoc. Test vai. CAM acetate + A2.',
  ...
  {id:'S_PAINT_LATEX',
   why_vi:'GIAO DUC: Son nuoc (latex) UOT = de (xa lanh + cao + D2). KHO = kho — dung moi/test goc, nhieu lan. CAM say khi con son. Thong bao ty le thap khi da kho.',
  ...
  {id:'S_EGG',
   why_vi:'GIAO DUC: Trung = protein (long trang) + mo (long do). CAM nong luc dau (nau protein). THU TU: cao → xa LANH → E1 → D2 (long do) → giat.',
  ...
  {id:'S_MILK',
   why_vi:'GIAO DUC: Sua = casein/whey + mo nhe. De chua o VN. CAM nong luc dau. THU TU: xa lanh → E1 → D2 neu mo → giat. Khac sua bot (sat) — khong B2 nhu cong thuc.',
  ...
  {id:'S_CHOCOLATE',
   why_vi:'GIAO DUC: Socola = cacao tannin + mo + duong + protein sua. THU TU: cao → xa lanh → E1 → D2 → A3/B1 trang. CAM nong/say khi con mo+mau.',
  ...
  {id:'S_GRASS',
   why_vi:'GIAO DUC: Co xanh = chlorophyll + protein + tannin. THU TU: A1 (con) tham mau xanh → E1 → B1 trang. CAM say khoa xanh. Khac "ho tinh bot/pul ieem".',
  ...
  {id:'S_MUD',
   why_vi:'GIAO DUC: Bun/dat = hat dat + tannin. VANG QUY TAC: de KHO → chai bot → roi giat. Uot cha = day bun vao soi. Khac laterite do (X2).',
  ...
  {id:'S_SWEAT_FRESH',
   why_vi:'GIAO DUC: Mo hoi tuoi = muoi + protein + vi khuan (mui). E1 + giat lanh/am. Khac VE O NACH VANG (S_SWEAT_YELLOW) / deodorant Al. CAM B2 len nach vang.',
...
UNWIND [
  {id:'S_SUNSCREEN',
   why_vi:'GIAO DUC: Kem chong nang VN = UV filter + dau silicon + ZnO. N3 (dau) hoa tan UV/silicon → D2 nhu hoa → giat. CAM B2 (vang VINH VIEN). Phoi nang ngan OK sau sach.',
  ...
  {id:'S_TAR',
   why_vi:'GIAO DUC: Nhua duong = dau KHO NHAT. THONG GIO. Dong cao → D1 + giay tham 6-10 lan → D2 → giat. Bao kiên nhẫn + ty le thap.',
  ...
  {id:'S_MASCARA',
   why_vi:'GIAO DUC: Masca = carbon black + sap/dau. Thuong: A1. Chong nuoc: D1. GIAY THAM duoi. KHONG cha. CAM B2 (xam vinh vien).',
  ...
  {id:'S_HAIR_DYE',
   why_vi:'GIAO DUC: Thuoc nhuom toc = pigment oxi hoa — SOM xa lanh. A1/B1 can than. Test. Da kho mau: ty le thap — bao truoc.',
...
UNWIND [
  ...
  {id:'I_BED_SHEET',name:'Bed sheet / fitted sheet',name_vi:'Ga giuong / drap',name_ko:'침대 시트·매트리스커버',fabric_id:'F1',
   ...
   why_vi:'GIAO DUC: Ga = 60C diet mite + UV nang VN. Trang: B1 neu vang. Mau: khong Javel. Phoi nang = sat khuan.',
  ...
  {id:'I_TOWEL',name:'Bath towel / washcloth',name_vi:'Khan tam / khan mat',name_ko:'수건·목욕타월',fabric_id:'F1',
   ...
   why_vi:'GIAO DUC: Khan 60C diet khuan. CAM softener/xa vai = mat tham. Say vua/cao = xop. VN: bat dau kho <4h.',
  ...
  {id:'I_BABY_WEAR',name:'Baby / infant clothing',name_vi:'Do tre so sinh / em be',name_ko:'아기·유아복',fabric_id:'F1',
   ...
   why_vi:'GIAO DUC: Da be = it kich ung. Bot khong muoi. 60C ve sinh / 40C tinh te. THEM xa. Vet: LUON lanh truoc (CAM nong khoa protein).',
  ...
  {id:'I_SWIMWEAR',name:'Swimwear / spandex suit',name_vi:'Do boi / do the thao stretch',name_ko:'수영복·스판덱스',fabric_id:'F2',
   ...
   why_vi:'GIAO DUC: Clo + nhiet = hong spandex. Tay: D3 it, lanh, vo nhe. May: tui luoi tinh te lanh. Ep khan — CAM vat xoan. Phoi bong mat.',
  ...
  {id:'I_ODOR_SMOKE',name:'Cigarette / smoke odor on textiles',name_vi:'Mui thuoc la / khoi tren vai',name_ko:'담배·연기 냄새 제거(섬유)',fabric_id:'F1',
   ...
   why_vi:'GIAO DUC: Nicotine+tar bam soi. A3 1:4 → N1 hut → giat nong an toan → nang+gio. Khong xit nuoc hoa che mui.',
