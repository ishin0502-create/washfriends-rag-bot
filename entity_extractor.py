...
S_FISH_SAUCE=nuoc mam/느억맘/액젓, S_KETCHUP=ketchup/케첩, S_TOMATO_SAUCE=tomato sauce/토마토소스/파스타소스/sốt cà,
S_FRUIT_JUICE=juice/주스, S_KIMCHI=kimchi/김치,
S_DOENJANG=doenjang/된장, S_GOCHUJANG=gochujang/고추장,
S_PERSIMMON=persimmon/감물/감즙, S_CRAYON=crayon/크레용, S_SOFTENER_SPOT=softener spot/유연제 얼룩,
...
S_VN_CHAIN_OIL=chain oil/dau xich/체인 기름/체인기름/오토바이 체인,
S_VN_GASOLINE=gasoline/xang,
S_VN_BRAKE_FLUID=brake fluid/dau thang,
S_VN_EXHAUST_SOOT=exhaust soot/bo hong,
S_VN_RUBBER_MARK=rubber mark/vet cao su,
S_VN_SWEAT_SUNSCREEN=sweat sunscreen/mo hoi kem chong nang,
S_VN_ACID_RAIN=dirty rain/vet mua,
S_VN_CEMENT=cement/xi mang,
...
S_PAINT_OIL=oil paint/유성페인트/son dau,
S_BETEL=betel/areca/빈랑/trầu/trau cau,
S_IODINE=iodine/povidone/요오드/thuốc đỏ/thuoc do/betadine,
S_CHILI=chili sauce/핫소스/칠리/tương ớt/tuong ot,
S_SHRIMP_PASTE=shrimp paste/mam tom/mắm tôm/새우젓/맘톰,
S_SUGARCANE=sugarcane juice/nuoc mia/nước mía/사탕수수즙/느억미아,
S_GAC=gac/gấc/bot gac/극/가정,
S_ANNATTO=annatto/dieu mau/điều màu/아나토/디에우마우,
